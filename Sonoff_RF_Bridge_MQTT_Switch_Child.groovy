...
metadata {
  definition (name: "Sonoff RF Bridge over MQTT - Switch Child Device over MQTT", namespace: "snargit", author: "David BAILEY", importUrl: "https://raw.githubusercontent.com/snargit/Hubitat/main/Sonoff_RF_Bridge_MQTT_Switch_Child.groovy") {
    capability "Actuator"
    capability "Switch"
  }
  preferences {
...
def updateCheck() {
  Map params = [uri: "https://raw.githubusercontent.com/snargit/Hubitat/main/Sonoff_RF_Bridge_MQTT_Switch_Child.groovy"]
